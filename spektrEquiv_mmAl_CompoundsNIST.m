function mmAl = spektrEquiv_mmAl_CompoundsNIST(q0,filter_list)

%%**************************************************************************
%% System name:      SPEKTR
%% Module name:      spektrEquiv_mmAl_CompoundsNIST.m
%% Version number:   2
%% Revision number:  00
...
for i=1:size(filter_list,1),
    qa = spektrBeersCompoundsNIST(q,[filter_list(i,1) filter_list(i,2)]);
    q = qa;
end
